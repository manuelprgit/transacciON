    ...
    return (
        <>
            ...
            <div className='flex justify-center gap-10'>
                <button
                    className={`h-10 w-40 bg-green-${active ? '500' : '300'} rounded-lg border border-solid transition active:bg-green-400 font-semibold text-green-900 flex justify-center items-center gap-1`}
                ...
                <button
                    className={`h-10 w-40 bg-red-${active === false ? '500' : '300'} rounded-lg border border-solid transition active:bg-red-400 font-semibold text-red-900 flex justify-center items-center gap-1`}
